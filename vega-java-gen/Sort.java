...
public class Sort {
    ...
    private Sort.Aggregate aggregate;
     ...
     */
    @JsonProperty("aggregate")
    public Sort.Aggregate getAggregate() {
        return aggregate;
    }
     ...
     */
    @JsonProperty("aggregate")
    public void setAggregate(Sort.Aggregate aggregate) {
        this.aggregate = aggregate;
    }

    public Sort withAggregate(Sort.Aggregate aggregate) {
        this.aggregate = aggregate;
        return this;
    }
    ...
    public Sort withReverse(Boolean reverse) {
        this.reverse = reverse;
        return this;
    }
    ...
    public static enum Aggregate {
        ...
        private static Map<String, Sort.Aggregate> constants = new HashMap<String, Sort.Aggregate>();
        ...
        public static Sort.Aggregate fromValue(String value) {
            Sort.Aggregate constant = constants.get(value);
            if (constant == null) {
